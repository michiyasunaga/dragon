...
wget -nc -P data/csqa/ https://raw.githubusercontent.com/michiyasunaga/qagnn/main/data/csqa/inhouse_split_qids.txt
...
# download Glove
wget -nc -P data/glove/ https://nlp.stanford.edu/data/glove.6B.zip
yes n | unzip data/glove/glove.6B.zip -d data/glove/glove.6B
